...
import com.hossam.lazadatest.view.customViews.OnLoadingImageFinishedListener;

/**
 * Created by Hossam on 5/15/2016.
 */
public class PhotoFragment extends Fragment implements OnLoadingImageFinishedListener {
    ...
    public void onResume() {
        super.onResume();
        imageView.loadWithUrl(photo.getImages().get(Utils.LARGE_IMAGE_INDEX).getUrl(), Utils.IMAGE_LOADING_TAG, false, this);
        userImageView.loadWithUrl(photo.getUser().getUserpic_url(), Utils.IMAGE_LOADING_TAG, true, null);
